...
3. En `Authentication > URL Configuration`, configurar:
   - **Site URL:** `https://acnbconsultoria.github.io/canfranc-rutas/`
   - **Redirect URLs:** `https://acnbconsultoria.github.io/canfranc-rutas/**`
